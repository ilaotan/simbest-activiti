...
public class TaskApiImpl implements TaskApi {
     ...
     * @return
     */
    public PageSupport<ActBusinessStatus> queryMyTask(final String uniqueCode,final String taskKeyCategory, final String code, final String title, final String processDefinitionKeys,final String demandUserName,final List<Integer> demandOrgIdss, final int pageindex, final int pagesize) {
        return customTaskService.queryMyTask(uniqueCode,taskKeyCategory,code,title,processDefinitionKeys, demandUserName,demandOrgIdss,pageindex, pagesize);
    }
